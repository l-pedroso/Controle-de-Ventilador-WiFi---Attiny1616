...
******************************************************************************/
#define PRODUCT_KEY "mcvcfoffkpagmw6i"    //The unique product identification generated after product is created on development platform
...
#define DPID_SWITCH_FAN 1
//Fan countdown(Issue and report)
#define DPID_COUNTDOWN_FAN 2
//Fan speed(Issue and report)
#define DPID_FAN_SPEED 4
//Fan light switch(Issue and report)
#define DPID_SWITCH_LED 5
//Fan light countdown(Issue and report)
#define DPID_COUNTDOWN_1 7
//Power-on state setting(Issue and report)
#define DPID_RELAY_STATUS 11
//Cycle Timing(Issue and report)
#define DPID_CYCLE_TIMING 101
//Fan Direction(Issue and report)
#define DPID_FAN_DIRECTION 102
